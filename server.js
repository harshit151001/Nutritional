...
app.use("/carecategory", express.static(path.join(__dirname, "digital")));
...
app.get("/carecategory/digital", function (req, res) {
  res.sendFile(path.join(__dirname, "digital.html"));
});
app.get("/carecategory/digital-literacy", function (req, res) {
